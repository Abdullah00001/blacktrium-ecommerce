...
const seedCountries = async () => {
  try {
    ...
    for (const country of countries) {
      // Check if the country already exists by countryCode
      const existingDoc = await CountryModel.findOne({
      ...
      if (!existingDoc) {
        ...
        // Uncomment the line below if you want verbose logs for skipped records
        // console.log(`⚠ Skipped (Already Exists): ${country.name} (${country.code})`);
        skippedCount++;
      }
    }
